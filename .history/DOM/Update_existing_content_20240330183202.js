...
// <-------- textContent -------->
   ...
   // If any content is set to display hidden then it will be printed in the text content
...
// <-------- innerText -------->
  // If any content is set to display hidden then it will not be printed in the inner text 
